...
function Order() {
  ...
  return (
    <div className="space-y-8 px-4 py-6">
      <div className="flex flex-col items-center justify-between gap-y-1 sm:flex-row">
      ...
      <div className="flex flex-col flex-wrap items-center justify-between gap-x-2 gap-y-1 bg-stone-200 px-6 py-5 sm:flex-row">
...
async function loader({ params }) {
  const menu = await getOrder(params.id);
  return menu;
}
export { loader };
