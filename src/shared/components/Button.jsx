...
function Button({
  ...
  const styles = {
    ...
    // secondary: ` text-stone-500 bg-transparent border-2 border-stone-300 px-4 py-2 text-sm sm:px-6 sm:py-3 hover:bg-stone-200 hover:text-stone-800 sm:text-base focus:ring-stone-200 focus:text-stone-800`,
    secondary:
